...
const StyledBox = styled('div')(({ theme }) => ({
  ...
  ...theme.applyStyles('dark', {
    boxShadow: '0 0 24px 12px hsla(120, 84%, 10%, 0.5)',
  ...
  return (
    <Box
      ...
      sx={(theme) => ({
        ...
        backgroundImage:
          'radial-gradient(ellipse 80% 50% at 50% -20%, hsl(120, 75%, 87%), transparent)',
        ...theme.applyStyles('dark', {
          backgroundImage:
            'radial-gradient(ellipse 80% 50% at 50% -20%, hsl(120, 75%, 16%), transparent)',
        }),
      })}
    >
      <Container
